...
// Importamos 'Link' directamente desde react-router-dom.
// Asegúrate de tener esta librería instalada en tu proyecto.
  ...
  return (
    ...
    ">
      {links.map(({ href, label }) => (
        // Usamos el componente Link real con la prop 'to'.
        <Link
          key={href}
          to={href}
          className="
