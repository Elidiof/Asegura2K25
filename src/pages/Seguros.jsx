...
export default function Seguros() {
  ...
  // Añadimos los dos nuevos productos
  const allProducts = [
    ...existingProducts,
    {
      link: 'https://asegura2k25.com/daa.html',
      icon: <DaaIcon />,
      title: 'Rellenar DAA Online',
      description: 'Accede a nuestra herramienta para rellenar la Declaración Amistosa de Accidente de forma fácil y rápida.',
      isExternal: true,
    },
    {
      ...
      description: 'Encuentra aquí los números de teléfono de asistencia de las principales compañías de seguros.',
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Nuestros Seguros y Servicios - Asegura2K25</title>
        <meta name="description" content="Explora nuestra gama de seguros y herramientas diseñadas para tu tranquilidad y seguridad." />
      </Helmet>
      <main className="bg-slate-100 py-12">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
              Nuestros Seguros y Servicios
            </h1>
            <p className="mt-4 max-w-2xl mx-auto text-lg text-slate-600">
              Soluciones a tu medida. Explora nuestra gama de seguros y herramientas diseñadas para tu tranquilidad.
            </p>
          </div>
